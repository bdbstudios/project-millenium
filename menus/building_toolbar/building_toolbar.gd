class_name BuildingToolbar extends CanvasLayer
...
@onready var core_scene = preload("res://entities/selectables/structures/core/Core.tscn")
@onready var miner_scene = preload("res://entities/selectables/structures/miner/Miner.tscn")
